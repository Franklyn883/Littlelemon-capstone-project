...
User API Endpoints
http://127.0.0.1:8000/users  -> GET -> show all the currents users
http://127.0.0.1:8000/users/   -> POST -. create a new user (fields: username and password)
http://127.0.0.1:8000/users/1 -> GET -> show user where id is 1
http://127.0.0.1:8000/users/1 -. DELETE -> delete user where id is 1
...
http://127.0.0.1:8000/api/menu/  -> POST -> create a new menu items
...
http://127.0.0.1:8000/restaurant/booking/ -> POST -> create a new booking
...
http://127.0.0.1:8000/api/menu/ 1 -> PATCH -> update the booking data, where id is 1
